...
describe('Service Tests', () => {
  describe('LikeCommentary Service', () => {
    ...
    let elemDefault: ILikeCommentary;
    ...
    beforeEach(() => {
      ...
      expectedResult = null;
      injector = getTestBed();
      service = injector.get(LikeCommentaryService);
      httpMock = injector.get(HttpTestingController);

      elemDefault = new LikeCommentary(0);
    });
    ...
    describe('Service methods', () => {
      ...
      it('should create a LikeCommentary', () => {
        ...
        service.create(new LikeCommentary()).subscribe(resp => (expectedResult = resp.body));
