...
export class CommentaryComponent implements OnInit, OnDestroy {
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    this.commentaryService
      ...
      .subscribe(
        (res: HttpResponse<ICommentary[]>) => this.onSuccess(res.body, res.headers, pageToLoad, !dontNavigate),
        () => this.onError()
      );
  }
  ...
  registerChangeInCommentaries(): void {
    this.eventSubscriber = this.eventManager.subscribe('commentaryListModification', () => this.loadPage());
  }
  ...
  protected onSuccess(data: ICommentary[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
